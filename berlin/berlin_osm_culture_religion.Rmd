---
title: "Berlin: Extracting Data of Cultural and Religious Locations from OSM"
...
# Convert for plot, not possible in pdf
bb_for_plot = bb[[1]] %>% as.data.frame()
...
paste("Number of museums in Berlin:", nrow(museums))
```
...
# Print how many were found
paste("Number of theatres in Berlin:", nrow(theatres))
```
...
# Print how many were found
paste("Number of nightclubs in Berlin:", nrow(nightclubs))
```
...
st_crs(bars)$input
# Print how many were found
paste("Number of bars in Berlin:", nrow(bars))
```
...
st_crs(pubs)$input
# Print how many were found
paste("Number of pubs in Berlin:", nrow(pubs))
```
...
# Print how many were found
paste("Number of buddhist PoW for Berlin:", nrow(buddhist))
```
...
st_crs(hindu)$input
# Print how many were found
paste("Number of hindu PoW for Berlin:", nrow(hindu))
```
...
st_crs(jewish)$input
# Print how many were found
paste("Number of jewish PoW for Berlin:", nrow(jewish))
```
...
st_crs(muslim)$input
# Print how many were found
paste("Number of muslim PoW for Berlin:", nrow(muslim))
```
...
st_crs(sikh)$input
# Print how many were found
paste("Number of sikh PoW for Berlin:", nrow(sikh))
```
...
protestant_denominations = c("protestant", "adventist", "anglican", "baptist", "churches_of_christ", "disciples_of_christ",
                             ...
                             "methodist", "moravian", "mormon",  "pentecostal","pentecostal", "presbyterian", "quaker", "reformed", 
...
# Print how many were found
paste("Number of protestant PoW for Berlin:", nrow(protestant))
```
...
# Print how many were found
paste("Number of catholic PoW for Berlin:", nrow(catholic))
```
