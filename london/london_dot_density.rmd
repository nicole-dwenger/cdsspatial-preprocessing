...
__count_dots__ = A function which generates how many dots should be created for each ethnicity, in each output area. The output is dataframe with a column for each ethnicity and a row for each output area, holding the number of dots which should be plotted for each. 
             
__generate_dots__ = A function which generates random coordinates for the dot, within the specified geographical area. Here, we use the smallest area shapefiles available, meaning that even though the coordinates are randomly generated, they should reflect the ethnicity of the area to an accurate degree.
