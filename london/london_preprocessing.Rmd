...
4. Religious Institutions (extracted and pre processed in `london_osm_culture_religion.Rmd`)
5. Cultural Institutions (extracted and pre processed in `london_osm_culture_religion.Rmd`)
...
# tree_mask = raster::mask(tree_cover, london_3035)
# Save as rds 
# saveRDS(tree_mask, "london/preprocessed_data/london_tree_mask.rds")
# This has been done, but here the mask is loaded for plotting
tree_mask = readRDS(here("london", "preprocessed_data", "london_tree_mask.rds"))
# Plot
plot(tree_mask)
plot(london_3035$geometry, add=TRUE)
...
# Save as rds
# saveRDS(tree_cropped, "london/preprocessed_data/london_tree_cropped.rds")
# This has been done, but here the cropped data is loaded for plotting
tree_cropped = readRDS(here("london", "preprocessed_data", "london_tree_cropped.rds"))
# Plot
plot(tree_cropped)
plot(london_3035$geometry, add=TRUE)
...
# raster1 = raster(here("london", "raw_data", "imperviousness", "IMD_2018_010m_E35N31_03035_v020.tif"))
...
# Transform london geometry to the same crs
...
# Save rds
# saveRDS(imperv_mask, "london/preprocessed_data/london_imperv_mask.rds")
# This has been done, but here the mask is loaded for plotting
imperv_mask = readRDS(here("london", "preprocessed_data", "london_imperv_mask.rds"))
# Plot
plot(imperv_mask);
plot(london_3035$geometry, add=TRUE)
...
# Save rds
# saveRDS(imperv_cropped, "london/preprocessed_data/london_imperv_cropped.rds")
# This has been done, but here the mask is loaded for plotting
imperv_cropped = readRDS(here("london", "preprocessed_data", "london_imperv_cropped.rds"))
# Plot
plot(imperv_cropped);
plot(london_3035$geometry, add=TRUE)
